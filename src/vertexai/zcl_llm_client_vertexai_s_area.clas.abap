class ZCL_LLM_CLIENT_VERTEXAI_S_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_LLM_CLIENT_VERTEXAI_S_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_LLM_CLIENT_VERTEXAI_SR read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_LLM_CLIENT_VERTEXAI_S_AREA
    raising
      CX_SHM_INCONSISTENT
...
CLASS ZCL_LLM_CLIENT_VERTEXAI_S_AREA IMPLEMENTATION.
